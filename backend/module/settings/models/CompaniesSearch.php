...
/**
 * CompaniesSearch represents the model behind the search form about `backend\module\settings\models\Companies`.
 */
class CompaniesSearch extends Companies
{
    ...
    public function rules()
    {
        return [
            [['company_id'], 'integer'],
            [['company_name', 'company_email', 'company_address', 'company_created_date', 'company_start_date', 'company_status'], 'safe'],
        ];
    }
